...
namespace ClientBase.Coroutine
{
    public class CoroutineManager : MonoBehaviour
    {
        ...
        {
            GameObject instanceHome = GameObject.Find(ClientBaseConst.NameGlobals);
        ...
        //public new void KillCoroutine(System.Collections.IEnumerator routine) { }
    ...
    public static class DeferExtensionMethods
    {
        ...
        {
            while (ClientBase.Coroutine.CoroutineManager.MainThread != System.Threading.Thread.CurrentThread || (gameObject && gameObject.activeInHierarchy && coroutine.MoveNext()))
        ...
        {
            while (ClientBase.Coroutine.CoroutineManager.MainThread != System.Threading.Thread.CurrentThread || (gameObject1 && gameObject1.activeInHierarchy &&
