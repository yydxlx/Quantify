...
namespace ClientBase
{
    ...
    public static class FileHelper
    {
        ...
        public static void DeleteDirectory([NotNull]string filepath)
        {
        ...
        public static void CopyDirectory([NotNull]string srcDir, [NotNull]string tgtDir)
        {
            ...
            Debug.Log(source);
            Debug.Log(source.FullName);
            Debug.Log(target);
            Debug.Log(target.FullName);
        ...
        /// <param name="filePath">文件路径</param>
        /// <returns></returns>
        public static bool DirectoryExist(string filePath)
        {
