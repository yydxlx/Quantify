...
{
    public class CocoonActTweenScale : CocoonTweenBase
    {
        [HideLabel]
       ...
       [HideInInspector]
        ...
        protected override void OnInit()
        {
            ...
            AniAudioSource = transform.GetComponent<AudioSource>();
...
#endif
        protected override void OnAnimationClipEnd()
        {
            base.OnAnimationClipEnd();
