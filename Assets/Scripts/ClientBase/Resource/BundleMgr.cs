...
namespace CocoonAsset
{
    ...
    {
        public string[] activeVariants { get; private set; }

        public string dataPath { get; private set; }

        public event OverrideDataPathDelegate overrideBaseDownloadingURL;

        public AssetBundleManifest manifest { get; private set; }

        readonly internal Dictionary<string, Bundle> bundles = new Dictionary<string, Bundle>();
        readonly List<Bundle> bundleToDestroy = new List<Bundle>();
        ...
        public bool Initialize(string path)
        {
            ...
            dataPath = path;
            var request = LoadInternal(AssetBundleUtility.AssetBundlesOutputPath, true, false);
        ...
        public System.Collections.IEnumerator InitializeAsync(string path, System.Action<Bundle> onComplete)
        {
            activeVariants = new string[0];
            dataPath = path;

            var request = LoadInternal(AssetBundleUtility.AssetBundlesOutputPath, true, true);
        ...
        Bundle LoadInternal(string assetBundleName, bool isLoadingAssetBundleManifest, bool asyncRequest)
        {
            ...
            //        return null;
            //    }
            //assetBundleName = RemapVariantName(assetBundleName);//没什么卵用
            //}

            var url = dataPath + assetBundleName;
            //Debug.Log(GetDataPath(assetBundleName));
