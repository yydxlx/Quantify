...
namespace CocoonAsset
{
    public class Manifest
    {
        ...
        {
            //Debug.Log(assetPath);
            //Debug.Log(amap.Count);
            //Debug.Log(amap[assetPath]);
            //Debug.Log(allBundles.Length);
            //Debug.Log(allBundles[amap[assetPath]]);
        ...
        public void Load(TextReader reader)
        {
            ...
            while ((line = reader.ReadLine()) != null)
            {
                ...
                else
                {
                    ...
                    //if(asset == "Assets/ABResources/Prefabs/Setting/EscDlg.prefab")
